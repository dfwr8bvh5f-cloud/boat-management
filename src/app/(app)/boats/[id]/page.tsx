          ...
          {boat.mmsi && (
            <div className="mt-3 overflow-hidden rounded-lg border border-fleet-border">
              <iframe
                ...
                src={`https://www.marinetraffic.com/en/ais/embed/zoom:10/centery:/centerx:/maptype:0/shownames:false/mmsi:${encodeURIComponent(boat.mmsi)}/shipid:/fleet:/fleet_id:/vtypes:/showmenu:false/remember:false`}
