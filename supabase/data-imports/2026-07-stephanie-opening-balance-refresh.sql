...
begin
  ...
  values (v_boat_id, v_marker, v_target_bank_balance - v_current_bank_balance, '2025-12-31', 'actual', 'approved');

  insert into public.cash_transactions (boat_id, type, amount, tx_date, notes, status)
  values (v_boat_id, 'received', v_target_cash_balance - v_current_cash_balance, '2025-12-31', v_marker, 'approved');
end $$;
